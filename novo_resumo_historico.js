...
// Eventos relevantes resumidos (apenas zona)
...
// ═══════════════════════════════════════════════════════════
// LÓGICA E130/9013 — Descarte de E130 com 9013 em ≤ 5 min
// ═══════════════════════════════════════════════════════════
...
for (const e130 of e130MesmaZona) {
  ...
  // Procurar um 9013 na mesma zona em até 5 min após o E130
...
if (totalEventos === 0) {
  ...
  if (e130Validos7d > 0) {
    resumoTexto += ` E130 na mesma zona ${zonaAtual}: ${e130Total7d} total, ${e130Descartados} descartados (9013 em ≤5min), ${e130Validos7d} válidos em ${diasDistintosE130Validos7d} dia(s) distinto(s).`;
  }
}
